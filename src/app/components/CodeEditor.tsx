...
export const CodeEditor = (
    ...
    return (
        <div
            ...
            />
            <div
                className="absolute top-2 right-4 text-xs text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity duration-200 select-none pointer-events-none">
                Scroll for more
            </div>
        </div>
    );
